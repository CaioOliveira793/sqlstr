...
///
/// ```
/// # use sqlstr::{SqlCommand, Void, SqlExpr, expr::item_separator_optional};
...
///
/// ```
/// # use sqlstr::{SqlCommand, Void, SqlExpr, expr::item_separator};
/// # use core::convert::Infallible;
/// # fn main() -> Result<(), Infallible> {
/// let mut sql: SqlCommand<Void> = SqlCommand::default();
/// sql.push_cmd("SELECT ");
...
///
/// ```
/// # use sqlstr::{SqlCommand, Void, SqlExpr, expr::separator_optional};
/// # use core::convert::Infallible;
/// # fn main() -> Result<(), Infallible> {
/// let mut sql: SqlCommand<Void> = SqlCommand::default();
/// sql.push_cmd("SELECT");
...
///
/// ```
/// # use sqlstr::{SqlCommand, Void, SqlExpr, expr::separator};
/// # use core::convert::Infallible;
/// # fn main() -> Result<(), Infallible> {
/// let mut sql: SqlCommand<Void> = SqlCommand::default();
/// sql.push_cmd("SELECT");
